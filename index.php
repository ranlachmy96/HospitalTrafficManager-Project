            ...
            <div class="index-form-box">
                <form action="#" method="post" id="frm">
                    <div class="form-group">
                        ...
                        <input type="text" id="index-form-input" class="form-control" name="id_user" id="id_user"
                            placeholder="הכנס תז">
                    </div>
                    <div class="form-group">
                        <label class="index-label" for="loginPass">סיסמא :</label>
                        <input type="password" id="index-form-input" class="form-control" name="loginPass"
                            id="loginPass" placeholder="הכנס סיסמא">
                    </div>
