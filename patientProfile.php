...
$query = "SELECT id, id_number, first_name, last_name, age, gender, urgency, type, time, date, id_department, email, comment FROM tbl_213_patients WHERE id_number = ?";
$stmt = mysqli_prepare($connection, $query);
mysqli_stmt_bind_param($stmt, "s", $patientID);
mysqli_stmt_execute($stmt);
mysqli_stmt_bind_result($stmt, $id, $id_number, $first_name, $last_name, $age, $gender, $urgency, $type, $time, $date, $id_department, $email, $comment);
